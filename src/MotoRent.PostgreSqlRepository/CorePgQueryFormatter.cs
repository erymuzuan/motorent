...
/// <summary>
/// PostgreSQL query formatter for Core schema entities.
/// Uses Core.Repository's DbExpressionVisitor (separate from Domain's).
/// Outputs double-quoted identifiers, || concat, true/false booleans.
/// </summary>
internal class CorePgQueryFormatter : DbExpressionVisitor
{
    ...
    protected override Expression VisitUnary(UnaryExpression u)
    {
        switch (u.NodeType)
        {
            ...
            case ExpressionType.Not:
                ...
                {
                    m_sb.Append($"(\"{ce.Name}\" = false)");
                    break;
                }

                if (u.Operand is MemberExpression me)
                {
                    m_sb.Append($"(\"{me.Member.Name}\" = false)");
                    break;
                }
    ...
    {
        if (b.Right is not ConstantExpression { Value: int intValue })
            return b.Right;
    ...
    protected override Expression VisitSelect(SelectExpression select)
    {
        ...
        if (select.Where != null)
        {
            ...
            {
                m_sb.Append($"(\"{me.Member.Name}\" = true)");
            }
            else
    ...
    protected override Expression VisitJoin(JoinExpression join)
    {
        ...
        switch (join.Join)
        {
            ...
            case JoinType.CrossApply:
                m_sb.Append("CROSS JOIN LATERAL ");
                break;
        }
