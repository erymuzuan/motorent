...
builder.Services.AddScoped<DocumentationTranslationService>(sp =>
{
    var httpClientFactory = sp.GetRequiredService<IHttpClientFactory>();
    var logger = sp.GetRequiredService<ILogger<DocumentationTranslationService>>();
    var env = sp.GetRequiredService<IWebHostEnvironment>();
    var docsPath = Path.Combine(env.WebRootPath, "user.guides");
...
app.MapGet("/manifest.json", () => Results.Json(new
{
    ...
    icons = new object[]
    {
        new { src = "images/icons/ios/32.webp", sizes = "32x32", type = "image/png" },
        new { src = "images/icons/android/android-launchericon-48-48.webp", sizes = "48x48", type = "image/png" },
        new { src = "images/icons/android/android-launchericon-72-72.webp", sizes = "72x72", type = "image/png" },
        new { src = "images/icons/android/android-launchericon-96-96.webp", sizes = "96x96", type = "image/png" },
        new { src = "images/icons/ios/128.webp", sizes = "128x128", type = "image/png" },
        new { src = "images/icons/android/android-launchericon-144-144.webp", sizes = "144x144", type = "image/png" },
        new { src = "images/icons/ios/152.webp", sizes = "152x152", type = "image/png" },
        new { src = "images/icons/ios/180.webp", sizes = "180x180", type = "image/png" },
        new { src = "images/icons/android/android-launchericon-192-192.webp", sizes = "192x192", type = "image/png", purpose = "any" },
        new { src = "images/icons/ios/256.webp", sizes = "256x256", type = "image/png" },
        new { src = "images/icons/android/android-launchericon-512-512.webp", sizes = "512x512", type = "image/png", purpose = "any" },
        new { src = "images/icons/ios/1024.webp", sizes = "1024x1024", type = "image/png" }
    },
    screenshots = new object[]
    {
        new { src = "screenshots/screenshot-wide.webp", sizes = "1280x720", type = "image/png", form_factor = "wide" },
        new { src = "screenshots/screenshot-mobile.webp", sizes = "750x1334", type = "image/png", form_factor = "narrow" }
    },
    categories = new[] { "business", "lifestyle", "travel" },
    shortcuts = new object[]
    {
        new { name = "Browse Vehicles", short_name = "Browse", description = "Browse available vehicles for rent", url = "/vehicles", icons = new[] { new { src = "images/icons/android/android-launchericon-96-96.webp", sizes = "96x96" } } },
        new { name = "Active Rentals", short_name = "Rentals", description = "View active rentals", url = "/rentals", icons = new[] { new { src = "images/icons/android/android-launchericon-96-96.webp", sizes = "96x96" } } },
        new { name = "Check-In", short_name = "Check-In", description = "Start a new rental", url = "/rentals/checkin", icons = new[] { new { src = "images/icons/android/android-launchericon-96-96.webp", sizes = "96x96" } } }
    },
